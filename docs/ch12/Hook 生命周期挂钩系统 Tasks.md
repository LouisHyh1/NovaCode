...
**文件:** `src/mewcode/permission/matcher.py`
**依赖:** 无
**步骤:**
...
**文件:** `tests/permission/test_matcher.py`
**依赖:** T1
**步骤:**
...
## T3: 升级 `permission.Rule` 与 `parse_rule`
...
## T5: 扩展 `test_rule` 与 `test_settings`

**文件:** `tests/permission/test_rule.py`、`tests/permission/test_settings.py`
**依赖:** T3、T4
**步骤:**
1. `test_rule`:补充用例
...
**文件:** `src/mewcode/hook/__init__.py`、`src/mewcode/hook/event.py`、`src/mewcode/hook/rule.py`
**依赖:** 无
**步骤:**
...
## T7: `hook.matcher` 字段路径求值

**文件:** `src/mewcode/hook/matcher.py`
**依赖:** T6、T1
**步骤:**
...
## T10: `hook.Engine` 与 dispatch 主流程

**文件:** `src/mewcode/hook/engine.py`
**依赖:** T6、T7
**步骤:**
...
## T11: `hook.Executor` 四类动作执行

**文件:** `src/mewcode/hook/executor.py`
**依赖:** T6
**步骤:**
...
**文件:** `tests/hook/test_executor.py`
**依赖:** T11
**步骤:**
...
**文件:** `src/mewcode/agent/runtime.py`、`tests/agent/test_runtime.py`
**依赖:** T6
**步骤:**
...
## T15: `Agent.__init__` 加 hook_engine 与 emit 框架

**文件:** `src/mewcode/agent/runtime.py`、`src/mewcode/agent/agent.py`
**依赖:** T14
**步骤:**
...
## T17: `test_agent` 拦截路径与 emit 覆盖

**文件:** `tests/agent/test_agent.py`、`tests/agent/test_runtime.py`
**依赖:** T16
**步骤:**
...
## T18: tui `MewCodeApp` 持有 `hook_engine`
...
**文件:** `src/mewcode/tui/app.py`、`src/mewcode/tui/commands.py`、`src/mewcode/tui/stream.py`
**依赖:** T18、T19
**步骤:**
...
**文件:** `src/mewcode/tui/hooks.py`、`src/mewcode/command/builtins.py`、`src/mewcode/command/ui.py`
**依赖:** T6、T10、T18
**步骤:**
