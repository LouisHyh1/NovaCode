...
**文件:** `src/mewcode/subagent/definition.py`
**依赖:** 无
**步骤:**
...
**文件:** `src/mewcode/subagent/parser.py`
**依赖:** T1
**步骤:**
...
**文件:** `src/mewcode/subagent/builtin/{general-purpose,explore,plan}.md`
**依赖:** 无
**步骤:**
...
**文件:** `src/mewcode/subagent/embed.py`
**依赖:** T2, T4
**步骤:**
1. 新建 `embed.py`,导入:
   ```python
...
**文件:** `src/mewcode/subagent/catalog.py`
**依赖:** T1, T2, T5
**步骤:**
...
**文件:** `src/mewcode/agent/permission_upgrade.py`
**依赖:** T10
**步骤:**
1. 新建文件,声明:
   ```python
...
**文件:** `src/mewcode/agent/run_to_completion.py`
**依赖:** T10, T14
**步骤:**
...
**文件:** `src/mewcode/task/manager.py`
**依赖:** T10, T15
**步骤:**
...
**文件:** `src/mewcode/tui/skill_fork.py`
**依赖:** T15
**步骤:**
...
**文件:** `src/mewcode/agent/launch.py`
**依赖:** T6, T15, T17
**步骤:**
1. 新建 `launch.py`,实现:
   ```python
