...
**文件：** `src/mewcode/mcp/config.py`、`src/mewcode/mcp/__init__.py`、`tests/test_mcp_config.py`
**依赖：** T1
**步骤：**
...
**文件：** `src/mewcode/mcp/tool.py`、`tests/test_mcp_tool.py`
**依赖：** T1
**步骤：**
...
**文件：** `src/mewcode/mcp/manager.py`、`src/mewcode/mcp/__init__.py`（追加导出）、`tests/test_mcp_manager.py`
**依赖：** T2、T3
**步骤：**
1. 模块级变量（非常量，便于单测改）：
   ```python
