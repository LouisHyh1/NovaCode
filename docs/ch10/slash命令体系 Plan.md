...
### `src/mewcode/command/builtin_ui.py`
...
### `src/mewcode/command/builtin_prompt.py`
...
### `src/mewcode/command/builtins.py`
...
### `src/mewcode/tui/commands.py` (改造)
**职责**：变成 thin glue:
